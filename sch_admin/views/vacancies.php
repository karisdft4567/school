...
<html lang="en">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/><!-- Meta, title, CSS, favicons, etc. --> <meta charset="utf-8"/><meta http-equiv="X-UA-Compatible" content="IE=edge"/><meta name="viewport" content="width=device-width, initial-scale=1"/><title>EVENT MANAGEMENT | Vacancy Details</title>
                                    ...
                                    <div class="x_content">
                                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                <li role="presentation" <?php if ($tab == 1) { ?>class="active" <?php } ?>><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Vacancy Details</a>
                                                </li>                                               
                                            </ul>
                                                 ...
                                                 <div class="col-md-12 col-sm-6 col-xs-12" style="float: right;">
                                                        <div class="x_panel">
                                                            <div class="x_title">
                                                                ...
                                                                <div class="alert alert-success alert-dismissible fade in" role="alert">
                                                                    ...
                                                                    <strong>Vacancy Details</strong> updated successfully!.
                                                                  </div>
                                                                <?php } ?>
                                                            <h2>Add Vacancy Details<small></small></h2> 
                                                    ...
                                                    <form id="demo-form" method="POST" enctype="multipart/form-data" action="../controllers/submit_details.php" data-parsley-validate class="form-horizontal form-label-left">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <input id="email_id" class="form-control col-md-7 col-xs-12" type="email" name="email_id"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                                <input type="hidden" id="action" name="action"  value="add_vacancy"/>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="x_panel">
                                                                <div class="x_title">
                                                                     <h2>List Vacancy Details<small></small></h2>  
                                                                    <ul class="nav navbar-right panel_toolbox">
                                                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                                                        </li>
                                                                    </ul>
                                                                ...
                                                                <div class="x_content">
                                                                    <table style="width:100%!important;" id="datatable" class="table table-striped table-bordered">
                                                                        ...
                                                                        <tbody id="happyhours_row">
                                                                           <?php
                                                                    $restuaranthappyhoursrows = get_allvacancies($con); //echo '<pre>';  print_r($restuarantreviewsrows);
                                                                    if ($restuaranthappyhoursrows != 0) {
                                                                        for ($hapyhourrow = 0; $hapyhourrow < count($restuaranthappyhoursrows); $hapyhourrow++) {
                                                                            ?>     <tr>
                                                                                        <td><?php echo $restuaranthappyhoursrows[$hapyhourrow]['title']; ?></td>
                                                                                        <td><?php echo $restuaranthappyhoursrows[$hapyhourrow]['description']; ?></td>
                                                                                        <td><?php echo $restuaranthappyhoursrows[$hapyhourrow]['email_id']; ?></td>
...
function ConfirmDelete(model_id,id){
  ...
  function deleteEventdetails(id){
        var dataobj = {
            vacancy_id: id, action:'deleteVacancydetails',
        };$('.opa').show();
        $.ajax({
            ...
            success: function (data) {
              window.location.href='vacancies.php?tab=1&message=1';
 ...
 function editCustomerdetails(id) {
        ...
        $.ajax({
       	    cache: false,
            url: "../ajax/edit_vacancy_detail.php",
            type: "POST",
            data: dataobj,
            success: function (data) {
