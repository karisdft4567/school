                                                        ...
                                                        <div class="form-group">
                                                         ...
                                                         <div class="form-group">
														   ...
														   <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <input name="update_news_image" type="file" class="file" data-preview-file-type="text" />
                                                                 <?php if($image_url!=""){?> 
																 <img style='height:100px;width:100px;' src='<?php echo $image_url;?>'/>
																 <input  name="news_image" type="hidden" class="file" data-preview-file-type="text" value="<?php echo $image_url;?>" />
																 <?php }?>
                                                            </div>
                                                        </div>  
