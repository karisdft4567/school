                                    ...
                                    <div class="x_content">
                                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                <li role="presentation" <?php if ($tab == 1) { ?>class="active" <?php } ?>><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Information Details</a>
                                                </li>                                               
                                            </ul>
                                                        ...
                                                        <div class="x_panel">
                                                            <div class="x_title">
                                                                ...
                                                                <div class="alert alert-success alert-dismissible fade in" role="alert">
                                                                    ...
                                                                    <strong>Messages Details</strong> updated successfully!.
                                                                  </div>
                                                                <?php } ?>
																
																 <?php if(isset($_GET['message']) && $_GET['message']!="" && $_GET['message']==2) {?> 
                                                                <div class="alert alert-success alert-dismissible fade in" role="alert">
                                                                    <span class="glyphicon glyphicon-ok-sign"></span>
                                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class="fa fa-close"></i>
                                                                    </button>
                                                                    <strong>Messages Details</strong> Deleted successfully!.
                                                                  </div>
                                                                <?php } ?>
                                                            <h2>Add Message Details<small></small></h2> 
                                                    ...
                                                    <form id="demo-form" method="POST" enctype="multipart/form-data" action="../controllers/submit_details.php" data-parsley-validate class="form-horizontal form-label-left">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <input id="message" class="form-control col-md-7 col-xs-12" type="text" name="message"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                                <input type="hidden" id="action" name="action"  value="add_message"/>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="x_panel">
                                                                <div class="x_title">
                                                                     <h2>List Message Details<small></small></h2>  
                                                                    <ul class="nav navbar-right panel_toolbox">
                                                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                                                        </li>
                                                                    </ul>
                                                                ...
                                                                <div class="x_content">
                                                                    <table style="width:100%!important;" id="datatable" class="table table-striped table-bordered">
                                                                        ...
                                                                        <tbody id="happyhours_row">
                                                                           <?php
                                                                    $message = get_allmessage($con); //echo '<pre>';  print_r($restuarantreviewsrows);
                           
                                                                        foreach($message as $message_details) {
                                                                            ?>     <tr>
																						<td><?php echo $message_details['message']; ?></td>
																						
                                                                                       
                                                                                        <td><?php echo $message_details['created_datetime']; ?></td>
                                                                                        <td>
                                                                                         <?php if($accessControl['Update']==1){?>
                                                                                        <a href="#" onclick="return editCustomerdetails(<?php echo $message_details['id'];?>)" data-target=".bs-example-modal-lg" data-toggle="modal" title="edit"><i class="fa fa-edit"></i></a>
                                                                                         <?php } ?>
                                                                                          <?php if($accessControl['Delete']==1){?>
                                                                                        <a href="#" onclick="return ConfirmDelete('deleteEventdetails',<?php echo $message_details['id'];?>)" data-toggle="tooltip" title="delete"><span aria-hidden="true" class="glyphicon glyphicon-remove"></span></a>
                                                                                        <?php } ?>
                                                                                        </td>
                                                                                        </tr>
                                                                            <?php
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Edit Message Details</h4>
                    </div>
...
function ConfirmDelete(model_id,id){
  ...
  function deleteMessagedetails(id){
        var dataobj = {
            message_id: id, action:'deletemessage',
        };$('.opa').show();
        $.ajax({
            ...
            success: function (data) { 
              window.location.href='message.php?tab=1&message=2';   //$('#categoryrow').html(data); $(".opa").fadeOut(500);
 ...
 function editCustomerdetails(id) {
        var dataobj = { message_id: id };
        $.ajax({
       	    cache: false,
            url: "../ajax/edit_message_details.php",
            type: "POST",
            data: dataobj,
            success: function (data) {
