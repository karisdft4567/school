                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                                        ...
                                                        <div class="x_panel">
                                                            <div class="x_title">
                                                                ...
                                                                <div class="alert alert-success alert-dismissible fade in" role="alert">
                                                                    ...
                                                                    <strong>Information Details</strong> updated successfully!.
                                                                  </div>
                                                                <?php } ?>
                                                            <h2>Add Information Details<small></small></h2> 
                                                    ...
                                                    <form id="demo-form" method="POST" enctype="multipart/form-data" action="../controllers/submit_details.php" data-parsley-validate class="form-horizontal form-label-left">
														...
														<div class="form-group">
														 ...
														 <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <input id="file" name="info_image" type="file" class="file" data-preview-file-type="text"  />
                                                            </div>
                                                        </div>  
                                                        <div class="ln_solid"></div>
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                                <input type="hidden" id="action" name="action"  value="add_information"/>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="x_panel">
                                                                <div class="x_title">
                                                                     <h2>List Information Details<small></small></h2>  
                                                                    <ul class="nav navbar-right panel_toolbox">
                                                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                                                        </li>
                                                                    </ul>
                                                                ...
                                                                <div class="x_content">
                                                                    <table style="width:100%!important;" id="datatable" class="table table-striped table-bordered">
                                                                        ...
                                                                        <tbody id="happyhours_row">
                                                                           <?php
                                                                    $info = get_allinformations($con); //echo '<pre>';  print_r($restuarantreviewsrows);
                                                                    
                                                                        foreach($info as $info_details) {
                                                                            ?>     <tr>
																						<td><?php echo $info_details['title']; ?></td>
																						
                                                                                        <td><?php echo $info_details['description']; ?></td>
																						
																						<td>
																						<a href="#" onclick="return loadImage(<?php echo $info_details['id']; ?>);">
																						<img src="<?php echo $info_details['image_url']; ?>" alt="image" class="img-thumbnail" style="width:100px;height:100px;"/>
																						</a></td>
                                                                                        <td><?php echo$info_details['created_datetime']; ?></td>
                                                                                        <td>
                                                                                         <?php if($accessControl['Update']==1){?>
                                                                                        <a href="#" onclick="return editCustomerdetails(<?php echo $info_details['id'];?>)" data-target=".bs-example-modal-lg" data-toggle="modal" title="edit"><i class="fa fa-edit"></i></a>
                                                                                         <?php } ?>
                                                                                          <?php if($accessControl['Delete']==1){?>
                                                                                        <a href="#" onclick="return ConfirmDelete('deleteEventdetails',<?php echo $info_details['id'];?>)" data-toggle="tooltip" title="delete"><span aria-hidden="true" class="glyphicon glyphicon-remove"></span></a>
                                                                                        <?php } ?>
                                                                                        </td>
                                                                                        </tr>
                                                                            <?php
